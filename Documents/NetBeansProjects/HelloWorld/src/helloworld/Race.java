...
public class Race extends JFrame implements ActionListener {
    ...
    public void startRace(Graphics g) {
        ...
        Paard h1 = new Paard("Ruben", Color.RED);
        Paard h2 = new Paard("Djamel", Color.BLACK);
        Paard h3 = new Paard("Jeroen", Color.BLUE);
        Paard h4 = new Paard("Bertram", Color.ORANGE);
